...
class Config(object):
    ...
    UPSTREAM_REPO = os.getenv("UPSTREAM_REPO", "https://github.com/XJWAL708/PALGHAR-1.git")
    # ------------------
    ...
    # used for alive plugin (default: XnKiT-UB logo image)
    ...
    # your assistants custom name (default: Xnkit)
    BOT_NAME = os.getenv("BOT_NAME", "Xnkit")
    # your assistants alive pic (optional)
    BOT_PIC = os.getenv("BOT_PIC", "https://te.legra.ph/file/e967f4118c9a0f30a67cf.jpg")
    ...
    THUMB_PIC = os.getenv("THUMB_PIC", "material/images/xnkit.png")
    # ---------------------
    # your telegraph account name (default: XnKiT-UB)
