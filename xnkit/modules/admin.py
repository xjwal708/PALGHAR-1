...
from xnkit.helpers.filters import gen
    ...
    try:
        ...
        if user:
            if user.user.is_self:
                return await app.send_edit(
                    m, "You can't ban yourself !", text_type=["mono"], delme=4
                )
        ...
        await app.send_edit(
            m, "The provided username | id is invalid !", text_type=["mono"], delme=4
        )
    except UserNotParticipant:
        await app.send_edit(
            m, "This user doesn't exist in this group !", text_type=["mono"], delme=4
        )
...
async def unban_handler(_, m: Message):
    try:
        ...
        if user:
            if user.user.is_self:
                return await app.send_edit(
                    m, "You can't unban yourself !", text_type=["mono"], delme=4
                )
            elif user.status == "administrator":
                return await app.send_edit(
                    m,
        ...
        if done:
            await app.send_edit(
                m, f"Unbanned {user.user.mention} in this chat.", delme=4
            )
        else:
            await app.send_edit(
                m, "Failed to unabn this user.", text_type=["mono"], delme=4
            )
...
async def mute_handler(_, m: Message):
    try:
        ...
        if user:
            if user.user.is_self:
                return await app.send_edit(
                    m, "You can't mute yourself !", text_type=["mono"], delme=4
                )
            elif user.status == "administrator":
                return await app.send_edit(
                    m,
        ...
        if mute_time:
            ...
            await app.send_edit(
                m, f"Muted {user.user.mention} in this chat for forever.", delme=4
            )
...
async def unmute_handler(_, m: Message):
    try:
        ...
        if user:
            if user.user.is_self:
                return await app.send_edit(
                    m, "You can't unmute yourself !", text_type=["mono"], delme=4
                )
            elif user.status == "administrator":
                return await app.send_edit(
                    m, "How do i unmute an admin ?", text_type=["mono"], delme=4
                )
            elif user.status == "creator":
                return await app.send_edit(
                    m, "How do i unmute a creator ?", text_type=["mono"], delme=4
                )
        else:
            return await app.send_edit(
                m, "Something went wrong !", text_type=["mono"], delme=4
...
async def kick_handler(_, m: Message):
    try:
        ...
        if user:
            if user.user.is_self:
                return await app.send_edit(
                    m, "You can't kick yourself !", text_type=["mono"]
                )
            elif user.status == "administrator":
                return await app.send_edit(
                    m, "How am i supposed to kick an admin ?", text_type=["mono"]
                )
            elif user.status == "creator":
                return await app.send_edit(
                    m,
        ...
        if done:
            ...
            await app.send_edit(
                m, "Failed to kick to user.", text_type=["mono"], delme=4
            )
...
async def pin_handler(_, m: Message):
    try:
        ...
        if m.chat.type in private:
            ...
            if done:
                return await app.send_edit(
                    m, "Pinned message !", text_type=["mono"], delme=4
                )
            else:
                return await app.send_edit(
                    m, "Failed to pin message.", text_type=["mono"], delme=4
                )
    ...
    try:
        ...
        if reply:
            ...
            if done:
                ...
                await app.send_edit(
                    m, "Failed to unpin message.", text_type=["mono"], delme=4
                )
            ...
            if cmd[1] == "all":
                ...
                if done:
                    await app.send_edit(
                        m, "Unpinned all pinned messages . . .", text_type=["mono"]
                    )
                else:
                    await app.send_edit(
                        m, "Failed to unpin all messages.", text_type=["mono"], delme=4
                    )
            elif cmd[1] != "all":
                await app.send_edit(
                    m,
                    "Reply to a pinned message to unpin or use `all` as a suffix to unpin all pinned messages.",
                    text_type=["mono"],
                    delme=4,
                )
            else:
...
async def promote_handler(_, m: Message):
    try:
        ...
        if user:
            if user.user.is_self:
                return await app.send_edit(
                    m, "You can't promote yourself !", text_type=["mono"]
                )
            elif user.status == "administrator":
                return await app.send_edit(
                    m,
...
async def demote_handler(_, m: Message):
    try:
        ...
        if user:
            if user.user.is_self:
                return await app.send_edit(
                    m, "You can't demote yourself !", text_type=["mono"]
                )
            elif user.status == "creator":
                return await app.send_edit(
                    m,
