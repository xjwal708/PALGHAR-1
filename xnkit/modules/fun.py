    ...
    try:
        ...
        if reply:
            ...
            if app.long(m) > 1:
                ...
                await app.send_edit(
                    m,
                    "Please give me some text after command . . .",
                    delme=2,
                    text_type=["mono"],
                )
        else:
...
async def type_handler(_, m):
    try:
        if app.long(m) > 1:
            ...
            return await app.send_edit(
                m, "Some text is required to show in typing animation", delme=2
            )
    ...
    if not reply:
        ...
        try:
            ...
            if _data:
                ...
                await app.send_edit(
                    m, "No insults found !", delme=4, text_type=["mono"]
                )
        except Exception as e:
            await app.error(m, e)
    ...
    if not reply:
        ...
        try:
            m = await app.send_edit(
                m, "Finding a good advice . . .", text_type=["mono"]
            )
...
async def question_handler(_, m):
    ...
    if not reply:
        await app.send_edit(
            m,
            "Please reply to someone, so that i can give them a question . . .",
            delme=2,
            text_type=["mono"],
        )
    elif reply:
        try:
            ...
            if question and answer:
                ...
                await app.send_edit(
                    m, "No question found !", delme=2, text_type=["mono"]
                )
        except Exception as e:
            await app.error(m, e)
...
async def moviequote_handler(_, m):
    try:
        ...
        if qt and role and show:
            ...
            await app.send_edit(
                m, "No movie quotes found !", delme=2, text_type=["mono"]
            )
    except Exception as e:
        await app.error(m, e)
...
async def joke_handler(_, m):
    try:
        ...
        await app.send_edit(
            m, "Server error, try again later.", text_type=["mono"], delme=4
        )
        await app.error(m, e)
