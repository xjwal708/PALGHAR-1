        ...
        inline_query.answer(
            results=[
                InlineQueryResultPhoto(
                    ...
                    description="This is xnkit security system, it helps you to stop spammers from spamming in your dm.",
        ...
        inline_query.answer(
            results=[
                InlineQueryResultPhoto(
                    ...
                    title="Introduction to asterix",
                    description="This is the xnkit helpdex menu.",
