...
settings = app.BuildKeyboard(
    (["• Settings •", "open-settings-dex"], ["• Modules •", "xnkit-dex-2"])
)
...
# modules dex
@app.bot.on_callback_query(filters.regex("xnkit-dex-2"))
@app.alert_user
...
async def _about(_, cb):
    await cb.edit_message_text(
        text=f"**Dex:** About\n\n**Location:** /home/about\n\n**[ Personal Info ]:**\n\n**Age:** {app.assistant_age}\n**Name:** {app.assistant_name}\n**Gender:** {app.assistant_gender}\n\n**[ Versions ]:**\n\n**Python:** {app.python_version}\n**Pyrogram:** {app.pyrogram_version}\n**Assistant:**  {app.assistant_version}\n\n**[ About ]:**\n\nI am XnKiT made by @XnKiTKuMaR\nI am your friendly assistant, i will help you as much as you need. You can ask me for any help related to your userbot. If you have any suggestions or you're facing any problems which are related to XnKiT-UB then just ask me [Ankit](https://t.me/XnKiTKuMaR), ",
        reply_markup=InlineKeyboardMarkup([home_back]),
    )
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "Restart bot",
                        callback_data="restart-xnkit",
                    ),
                ],
                [
                    InlineKeyboardButton(
                        "Shutdown bot",
                        callback_data="shutdown-xnkit",
                    )
                ],
                [
                    InlineKeyboardButton(
                        "Update bot",
                        callback_data="update-xnkit",
                    )
                ],
                home_back,
            ]
...
@app.bot.on_callback_query(filters.regex("update-xnkit"))
@app.alert_user
...
@app.bot.on_callback_query(filters.regex("restart-xnkit"))
@app.alert_user
async def _restart_xnkit(_, cb):
    await cb.edit_message_text(
...
@app.bot.on_callback_query(filters.regex("shutdown-xnkit"))
@app.alert_user
async def _shutdown_xnkit(_, cb):
    await cb.edit_message_text(
